...
>
	{@render Card("/words", "Words", WordsIcon)}
	{@render Card("/words/study", "Study words", StudyIcon)}
	{@render Card("/settings", "Settings", SettingsIcon)}
	{@render Card("/sandbox", "Sandbox", SandboxIcon)}
</main>
