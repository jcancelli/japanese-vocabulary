<script lang="ts">
	...
	let { word }: EditPreNounAdjectivalPageProps = $props()
</script>

<EditWordPage
	{word}
	Schema={PreNounAdjectivalSchema}
>
	{#snippet children(word: PreNounAdjectivalDTO, errors: Errors<PreNounAdjectivalDTO>)}
		<!-- Kanji -->
		<KanjiFragment
